...
func _ready() -> void:
	...
	sfx["shoot"] = _mk_player(_tone([1200.0, 700.0], 0.06, 0.25, "square"))
	sfx["hurt"] = _mk_player(_tone([300.0, 180.0], 0.15, 0.35, "square"))
	sfx["dash"] = _mk_player(_tone([200.0, 600.0], 0.08, 0.30, "noise"))
	sfx["switch"] = _mk_player(_tone([500.0, 500.0, 900.0], 0.12, 0.30, "square"))
	sfx["warp"] = _mk_player(_tone([400.0, 800.0, 1400.0, 2000.0], 0.30, 0.30, "sine"))
	sfx["checkpoint"] = _mk_player(_tone([600.0, 900.0], 0.14, 0.28, "sine"))
	sfx["item"] = _mk_player(_tone([700.0, 1000.0, 1300.0, 1600.0], 0.35, 0.30, "square"))
	sfx["heart"] = _mk_player(_tone([800.0, 1100.0], 0.12, 0.28, "sine"))
	sfx["sword"] = _mk_player(_tone([900.0, 400.0], 0.07, 0.28, "noise"))
